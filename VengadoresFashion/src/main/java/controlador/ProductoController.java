...
import modelo.dao.ProductoFacade;
...
public class ProductoController implements Serializable {
    ...
    @EJB
    private modelo.dao.ProductoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ProductoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ProductoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ProductoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
